...
class Game {
    ...
    #newGame() {
        ...
        this.#createEnemyInterval = setInterval(() => this.#randomNewEnemy(), 500);
    }
    ...
    #updateLives() {
        ...
        setTimeout(() => this.#htmlElements.container.classList.remove('hit'), 10);
        if (!this.#lives) {
            this.#endGame();
        }
    }
    ...
    #updateLivesText() {
        ...
        this.#htmlElements.scoreInfo.textContent = `You lose. Your score is ${this.#score}`;
